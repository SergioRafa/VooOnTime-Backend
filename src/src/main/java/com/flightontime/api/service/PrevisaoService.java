...
public class PrevisaoService {
    ...
    public PrevisaoResponse preverAtrasoComVooReal(String ident) {
        ...
        mockRequest.setDistanciaKm(400);
    ...
    private Map<String, Object> preProcessar(PrevisaoRequest request, ClimaResponseDTO clima, boolean trafegoCritico) {
        ...
        features.put("distancia_km", (double) request.getDistanciaKm());
        features.put("hora_partida", (double) dataHora.getHour());
        features.put("dia_semana", (double) dataHora.getDayOfWeek().getValue());
